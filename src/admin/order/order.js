...
export class Order {
  ...
  configureRouter(config, router) {
    ...
    config.map([
      { route: '', redirect: 'new' },
      { route: 'new', name: 'new', moduleId: './new/new', nav: true, title: 'עבודות חדשות', settings: { icon: 'fa-file-alt' } },
      { route: 'approved', name: 'approved', moduleId: './approved/approved', nav: true, title: 'עבודות שאושרו', settings: { icon: 'fa-thumbs-up' } },
      { route: 'in-progress', name: 'inProgress', moduleId: './in-progress/in-progress', nav: true, title: 'עבודות בתהליך', settings: { icon: 'fa-tasks' } },
      { route: 'waiting', name: 'waiting', moduleId: './waiting/waiting', nav: true, title: 'עבודות המשך', settings: { icon: 'fa-clock' } },
      { route: 'done', name: 'done', moduleId: './done/done', nav: true, title: 'עבודות סגורות', settings: { icon: 'fa-clipboard-check' } }
    ]);
    this.router = router;
